...
- Workspace ID: `5f151703-d86e-4437-ab8a-84106d3efcc8`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/5f151703-d86e-4437-ab8a-84106d3efcc8.
...
2. `npx ngodingpakeai connect --workspace 5f151703-d86e-4437-ab8a-84106d3efcc8 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/5f151703-d86e-4437-ab8a-84106d3efcc8. Only pass on links the CLI actually printed — never assemble one from an id yourself.
